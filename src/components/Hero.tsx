...
import { ChevronDown, Calendar, Users, Star, Sparkles, MessageCircle } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            >
              ...
              <span>Ankara'nın En Şık Düğün & Etkinlik Mekanıı</span>
            </motion.div>
            ...
            >
              Ankara'da <span className="text-gradient">Andora</span> ile hayalinizdeki düğünü gerçeğe dönüştürün
            </motion.h1>
            ...
            >
              Modüler salon yerleşimi, esnek 150-400 kişilik kapasitesi, büyüleyici ışıklandırması ve profesyonel düğün organizasyon kadromuzla hayatınızın en kıymetli gününü kusursuz kılıyoruz.
            </motion.p>
            ...
            >
              {["📍 Ankara / Merkezi", "✨ Düğün & Nişan & Kına", "🌸 Özel Masa Dekorasyon", "💬 WhatsApp İletişim"].map((pill) => (
                <span
                  key={pill}
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white/80 aspect-[4/3] lg:aspect-[1/1] z-10 group">
              <img
                ...
                alt="Andora Wedding & Events Ankara lüks düğün salonu masa düzeni"
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-champagne-100 flex items-center justify-between">
                <div>
                  ...
                  <span className="text-sm font-bold text-slate-800 block">150 - 400 Kişilik Masa Düzeni</span>
                </div>
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <div className="space-y-1">
              <span className="block font-display text-2xl sm:text-3xl font-extrabold text-champagne-700">500+</span>
              <span className="block text-xs sm:text-sm font-medium text-slate-600">Mutlu Çift Referansı</span>
            </div>

            <div className="space-y-1">
              <span className="block font-display text-2xl sm:text-3xl font-extrabold text-champagne-700">10+ Yıl</span>
              <span className="block text-xs sm:text-sm font-medium text-slate-600">Sektör & Organizasyon Pratiği</span>
            </div>

            <div className="space-y-1">
              <span className="block font-display text-2xl sm:text-3xl font-extrabold text-champagne-700">Esnek</span>
              <span className="block text-xs sm:text-sm font-medium text-slate-600">Bütçe & Ödeme Kolaylığı</span>
            </div>
            ...
            <div className="space-y-1">
              ...
              <span className="block text-xs sm:text-sm font-medium text-slate-600">Google Yüksek Puan Skoru</span>
            </div>
