...
import { Check, Flame, MessageSquare, PartyPopper } from "lucide-react";
...
export default function Services() {
  ...
  const servicesData: ServiceItem[] = [
    {
      ...
      description: "Bizim için her düğün, çiftimizin ruhunu yansıtan eşsiz bir sanat eseridir. En ince detayına kadar titizlikle planlanan muhteşem törenler.",
      imageUrl: "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?auto=format&fit=crop&q=80&w=800",
      features: [
        "150 - 400 davetli oturma kapasitesi",
        "İsteğe özel yemekli & kokteyl menü alternatifleri",
        "Profesyonel orkestra, DJ ve modern ses/ışık altyapısı",
        "Konforlu, özel tasarlanmış lüks gelin ve damat odası",
        "Çiftlerin salona girişine özel ışık & sis gösterileri",
        "Kesintisiz HD video kaydı ve dış mekan fotoğraf köşesi",
      ],
    },
    {
      id: "ser-2",
      category: "engagement-henna",
      badge: "Kına & Nişan",
      ...
      features: [
        ...
        "Kuru kına, yaş kına ve el gülü gibi eksiksiz aksesuarlar",
        "Kına türküleri için özel ses repertuvarı ve davul şov",
        "Misafirlere kına tepsisiyle lokum ve ikram sunumu",
        "Modern nişan masası arka plan dekor seçenekleri",
      ],
    },
    {
      id: "ser-3",
      ...
      description: "Evlatlarınızın bu gururlu ilk adımını, tüm sülalenizin gururla ve neşeyle hatırlayacağı görkemli şenliklerle kutluyoruz.",
      imageUrl: "https://images.unsplash.com/photo-1513151233558-d860c5398176?auto=format&fit=crop&q=80&w=800",
      features: [
        "Sünnet çocuğu için altın işlemeli yeni taht merasimi",
        "Yeniçeri askeri kostümlü salon giriş seremonisi",
        "Çocuklara özel animasyonlar, palyaço ve balon şovları",
        "Özel lezzetli çocuk menü tabak alternatifleri",
        "Masalarda neşeli renk konseptli balon süslemeleri",
        "Popcorn veya pamuk şeker tezgahı kiralama imkanı",
      ],
    },
    {
      id: "ser-4",
      ...
      description: "Kurumsal logonuzu ve marka değerinizi ön plana çıkaracak prestijli lansmanlar, şık yıl sonu partileri ve özel kokteyl menüleri.",
      imageUrl: "https://images.unsplash.com/photo-1469371670807-013ccf25f16a?auto=format&fit=crop&q=80&w=800",
      features: [
        "Marka kimliğinize uygun LED ve ışık renk konfigürasyonu",
        "Podyum, sahne yerleşimi ve akıllı projeksiyon kurulumu",
        "Karşılama hostesi, yönlendirme ve kayıt masası",
        "Zengin içerikli bistro masa kokteyl ikramları",
        "Gelişmiş kablosuz mikrofonlar ve kürsü donanımı",
        "Merkezi havalandırma ve her mevsim ideal iç iklim",
      ],
    },
  ];
  ...
  const tabs: { id: "all" | "wedding" | "engagement-henna" | "corporate"; label: string }[] = [
    { id: "all", label: "Tüm Hizmetler" },
    { id: "wedding", label: "Düğün Merasimi" },
    { id: "engagement-henna", label: "Nişan & Kına" },
    { id: "corporate", label: "Kurumsal Davetler" },
  ];

  return (
    <section
      id="hizmetler"
      className="py-24 bg-gradient-to-b from-champagne-50/20 to-white relative scroll-mt-20"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <p className="text-slate-600 text-sm sm:text-base max-w-2xl mx-auto pt-2">
            Ankara'da her türden özel kutlama ve kurumsal organizasyon için özel tasarlanan konseptlerimiz ile yanınızdayız. En sevdiğiniz paketi seçin ve gerisini ekibimize bırakın.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          <AnimatePresence mode="popLayout">
            {filteredServices.map((service, index) => (
              ...
              >
                <div>
                  {/* Aspect image header with overlay badge */}
                  ...
                  <div className="p-6 sm:p-8 space-y-4">
                    ...
                    <div className="pt-2 border-t border-champagne-50">
                      <span className="text-[10px] sm:text-xs font-bold text-slate-400 block uppercase tracking-wider mb-2">
                        PAKET ÖZETİ & DETAYLAR
                      </span>
        ...
        {/* Bottom banner for personalized events */}
        <div className="mt-16 p-8 rounded-3xl bg-gradient-to-tr from-champagne-850 to-champagne-750 text-white border border-champagne-700/35 flex flex-col md:flex-row items-center justify-between gap-6 shadow-md shadow-champagne-900/10">
          <div className="space-y-2 text-center md:text-left">
            ...
            <h3 className="font-display text-2xl font-bold tracking-tight text-white">
              Listede olmayan özel bir planlama mı hayal ediyorsunuz?
            </h3>
            <p className="text-champagne-100 text-xs sm:text-sm max-w-2xl leading-normal">
              Açık hava törenleri, özel brunchlar, mezuniyet baloları veya tematik çekimler için Ankara Andora Wedding yaratıcı gücüyle yanınızda.
            </p>
          </div>
          <a
